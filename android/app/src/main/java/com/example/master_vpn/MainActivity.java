package com.example.master_vpn;
...
public class MainActivity extends FlutterActivity {
    ...
    public void configureFlutterEngine(@NonNull FlutterEngine flutterEngine) {
        ...
        vpnControlEvent = new EventChannel(flutterEngine.getDartExecutor().getBinaryMessenger(),
        ...
        vpnStatusEvent = new EventChannel(flutterEngine.getDartExecutor().getBinaryMessenger(),
            ...
            switch (call.method) {
                ...
                case "start":
                    ...
                    if (call.argument("dns1") != null)
                        dns1 = call.argument("dns1");
                    if (call.argument("dns2") != null)
                        dns2 = call.argument("dns2");
